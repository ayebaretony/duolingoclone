...
> **Next.js:** Create `proxy.ts` (Next.js <=15: `middleware.ts`). Refer to the [Clerk Next.js docs](https://clerk.com/docs/get-started/nextjs) for middleware strategies.
...
- `clerk-expo-patterns` - Expo / React Native patterns
- `clerk-webhooks` - Webhook → database sync
- `clerk-backend-api` - Backend REST API explorer

**Other Clerk topics** (refer to [Clerk docs](https://clerk.com/docs)):
- Advanced Next.js, React, Vue, Nuxt, Astro, React Router, and TanStack patterns
- B2B multi-tenant organizations
- Native iOS and Android authentication
- E2E testing setup
